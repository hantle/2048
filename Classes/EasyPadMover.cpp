...
// -1 == no move at all
// > 0 == move
int EasyPadMover::calcPoint(int point, bool move)
{
...
// 0 move
// > 0 merged
int EasyPadMover::checkMove(Board *board, int r1, int c1, int r2, int c2)
{
...
int EasyPadMover::moveLeft(Board *board)
{
...
int EasyPadMover::moveRight(Board *board) 
{
    int size = board->getSize();
    bool move = false;
    int point = -1;
...
int EasyPadMover::moveUp(Board *board)
{
    int size = board->getSize();
    bool move = false;
    int point = -1;
...
int EasyPadMover::moveDown(Board *board)
{
    int size = board->getSize();
    bool move = false;
    int point = -1;
